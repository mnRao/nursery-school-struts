...
public class StudentHasSelectedOnlyFeeExcelGenerator extends StudentExcelManager {
	...
	public StudentHasSelectedOnlyFeeExcelGenerator(WritableWorkbook workbook, Month month, String feeName, List<Student> students) {
	...
	public void addContent(int sheetNumber) throws IOException, WriteException {
		...
		WritableSheet sheet = this.workbook.createSheet(this.feeName, sheetNumber);
		// Write contents
		this.addStyles();
	...
	private String generateTopMostHeaderLabel() {
		...
		headerTop.append(Helper.getI18N(I18N.EXCEL_HEADER_TOP_STUDENTHASSELECTEDONLYFEE, new String[] {
