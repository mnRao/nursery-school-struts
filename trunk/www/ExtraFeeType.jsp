				...
				<div class="tab-content" id="myTabContent">
					...
					<div id="firstTab"
						...
						<table cellpadding="0" cellspacing="0" border="0" class="display"
							...
							<thead>
								<tr>
									<th><s:text name="label.extraFeeType.extraFeeTypeId" /></th>
									<th><s:text name="label.extraFeeType.name" /></th>
									<th></th>
								</tr>
							</thead>
							<tbody>
								<s:iterator value="extraFeeTypes">
									<tr class="gradeC">
										<td><s:property value="extraFeeTypeId" /></td>
										<td><s:property value="name" /></td>
										<td>
										   <s:url id="editUrl"
										      action="editExtraFeeType">
										      <s:param name="extraFeeTypeId" value="%{extraFeeTypeId}" />
										   </s:url>
										   <s:a cssClass="btn btn-sm btn-primary" href="%{editUrl}">Edit</s:a>
										   <s:url id="deleteUrl" action="deleteExtraFeeType">
										      <s:param name="extraFeeTypeId" value="%{extraFeeTypeId}" />
										   </s:url>
					...
					<div id="secondTab"
						...
						<s:form action="saveOrUpdateExtraFeeType" cssClass="form-horizontal">
							<fieldset>
								<legend class="section">
									<s:text name="form.legend" />
								</legend>
								<div class="control-group">
									<s:push value="extraFeeType">
										...
										<div class="col-md-4">
											<div class="form-group">
												<s:textfield key="label.extraFeeType" name="name"
