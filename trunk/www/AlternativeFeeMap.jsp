						...
						<table cellpadding="0" cellspacing="0" border="0" class="display"
							...
							<thead>
								<tr>
									...
									<th><s:text name="label.alternativeFeeMap.alternativeAmount" /></th>
									<th></th>
								</tr>
							</thead>
							<tbody>
								<s:iterator value="alternativeFeeMaps">
									<tr class="gradeC">
										<td><s:property
												value="paymentFee.payment.label" /></td>
										<td><s:property value="paymentFee.fee.name" /></td>
										<td><s:property value="alternativeAmount" /></td>
										<td><s:url id="editUrl" action="editAlternativeFeeChargeMap">
												<s:param name="feeId"
							...
							<fieldset>
								...
								<div class="control-group">
									...
									<div class="col-md-4">
										<div class="form-group">
											<s:select list="feeList" listKey="feeId"
												listValue="name" name="feeId" headerKey="-1"
									...
									<div class="col-md-4">
										<div class="form-group">
											<s:select list="paymentList" listKey="paymentId"
												listValue="label" name="paymentId" headerKey="-1"
									...
									<s:push value="alternativeFeeMap">
										...
										<div class="col-md-4">
											<div class="form-group">
												<s:textfield key="label.alternativeFeeMap.alternativeAmount" name="alternativeAmount"
