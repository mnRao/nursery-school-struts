						...
						<table cellpadding="0" cellspacing="0" border="0" class="display"
							...
							<tbody>
								<s:iterator value="payments">
									<tr class="gradeC">
										<td><s:property
												value="studentFeeDetails.student.studentId" /></td>
										<td><s:property
												value="studentFeeDetails.feeDetails.feeDetailsId" /></td>
										...
										<td><s:url id="editUrl" action="editPayment">
												<s:param name="studentId"
													value="%{studentFeeDetails.student.studentId}" />
												<s:param name="feeDetailsId"
													value="%{studentFeeDetails.feeDetails.feeDetailsId}" />
						...
						<s:form action="saveOrUpdatePayment" cssClass="form-horizontal">
							<fieldset>
								...
								<div class="control-group">
									...
									<div class="col-md-2">
										<s:label key="label.payment.feeDetailsId"
											cssClass="control-label" />
									</div>
									<div class="col-md-4">
										<div class="form-group">
										...
										<div class="col-md-4">
											<div class="form-group">
												<s:textfield key="label.payment.absenceCount"
													name="absenceCount" cssClass="form-control" />
											</div>
										</div>
										<div class="col-md-2">
