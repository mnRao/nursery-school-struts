...
<script class="include" type="text/javascript"
	src="assets/javascript/jquery191.min.js"
></script>
<script class="include" type="text/javascript"
	src="assets/javascript/jquery.jqplot.min.js"
></script>
...
<script type="text/javascript" charset="utf-8">
	$(document).ready(function() {
		$('#dynamicTable').dataTable({
			...
			"oLanguage" : {
				"sUrl" : "assets/js/dataTables.vi.txt"
			}
		});
	});
</script>
...
<script type="text/javascript" charset="utf-8">
	$(document).ready(function() {
		$('#dynamicTable').dataTable({
			...
			"oLanguage" : {
				"sUrl" : "assets/js/dataTables.en.txt"
			}
		});
	});
</script>
...
<div class="demo_changer" style="right: -145px;">
	...
	<div class="form_holder">
		<div class="predefined_styles">
			...
			></a> <a class="styleswitch" rel="b" href="#"><img alt=""
				src="assets/images/b.jpg"
			></a> <a class="styleswitch" rel="c" href="#"><img alt=""
				src="assets/images/c.jpg"
			></a> <a class="styleswitch" rel="d" href="#"><img alt=""
				src="assets/images/d.jpg"
			></a> <a class="styleswitch" rel="e" href="#"><img alt=""
				src="assets/images/e.jpg"
			></a> <a class="styleswitch" rel="f" href="#"><img alt=""
				src="assets/images/f.jpg"
			></a> <a class="styleswitch" rel="g" href="#"><img alt=""
				src="assets/images/g.jpg"
			></a> <a class="styleswitch" rel="h" href="#"><img alt=""
				src="assets/images/h.jpg"
			></a> <a class="styleswitch" rel="i" href="#"><img alt=""
				src="assets/images/i.jpg"
			></a> <a class="styleswitch" rel="j" href="#"><img alt=""
